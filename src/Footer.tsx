...
const Footer = () => {
    return <div className="relative bottom-0 from-black to-gray-700 text-2xl md:text-4xl text-amber-50 self-stretch w-screen md:w-60 flex justify-center max-h-96 items-center text-center">
